...
import {JourneysDiscoverComponent} from '../../components/journeys-discover/journeys-discover.component';
...
import {JourneyImageComponent} from '../../components/journey-image/journey-image.component';
import {MyJourneysComponent} from '../../components/my-journeys/my-journeys.component';
import {MyJourneyPreviewComponent} from '../../components/my-journey-preview/my-journey-preview.component';
...
export const ExportComponentsObj = {
  ...
  JourneyDiscover: JourneysDiscoverComponent,
  CreateJourney: CreateJourneyComponent,
  UploadPicturesForm: UploadPictureFormComponent,
  JourneyPreview: JourneyPreviewComponent,
  JourneyDetails: JourneyDetailsComponent,
  JourneyImage: JourneyImageComponent,
  MyJourneys: MyJourneysComponent,
  MyJourneyPreview: MyJourneyPreviewComponent,
  EditJourney: EditJourneyComponent,
  Page404: Page404Component,
  AdminPanel: AdminPanelComponent,
  FiltersContainer: FiltersContainerComponent,
  Profile: ProfileComponent,
  EditPictureForm: EditPictureFormComponent,
  AdminImage: AdminImageComponent,
